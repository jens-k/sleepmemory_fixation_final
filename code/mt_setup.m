...
textControl = {  ...
    ...
    'In jedem Lauf wird eine bestimmte Anzahl von Karten'
    'nacheinander dunkler werden.'
    ''
    'Ihre Aufgabe: Zählen Sie, wie viele Karten insgesamt dunkler werden.'
    'Schauen Sie dabei ganz entspannt auf das Kreuz in der Mitte der'
    'jeweils verdunkelten Karte.'
    ''
    'Viel Spaß!'
    };
textFixation = {  ...
